def get_transactions_data
  ...
  transactions_block ||= []
  blank_transaction = Hash[from: "", to: "",what: "",description: "", qty: ""]
  loop do
    puts "" 
    ...
    what = gets.chomp
    puts "" 
    puts "What do you want to description ?"
    ...
    transaction = Hash[from: "#{from}", to: "#{to}", what: "#{what}", description: "#{description}", qty: "#{qty}"]
