...
def create_first_block
  ...
  instance_variable_set( "@b#{i}", 
                         Block.first( 
                          { from: "Dutchgrown", to: "Vincent", what: "Tulip Bloemendaal Sunset", description:"Rose" ,qty: 10 },
                          { from: "Keukenhof", to: "Anne", what: "Tulip Semper Augustus", description:"Blue" ,qty: 7 } )
                       )
  LEDGER << @b0
  pp @b0
  p "============================"
